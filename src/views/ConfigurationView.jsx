            ...
            <div style={{ maxWidth: 560 }}>
              {activeTab === 'schools' && (
                <>
                  ...
                  <StyledInput value={editingItem.name || ''} onChange={e => setEditingItem({ ...editingItem, name: e.target.value })} />
                  <FormLabel>Address</FormLabel>
                  <StyledInput value={editingItem.address || ''} onChange={e => setEditingItem({ ...editingItem, address: e.target.value })} />
                </>
              )}
              ...
              {activeTab === 'classrooms' && (
                <>
                  ...
                  <StyledSelect value={editingItem.school_id ?? ''} onChange={e => setEditingItem({ ...editingItem, school_id: e.target.value })}>
                ...
                <>
                  <div style={{ display: 'flex', gap: 16 }}>
                    <div style={{ flex: 1 }}>
                      ...
                      <StyledInput value={editingItem.first_name || ''} onChange={e => setEditingItem({ ...editingItem, first_name: e.target.value })} />
                    </div>
                    <div style={{ flex: 1 }}>
                      <FormLabel>Last Name</FormLabel>
                      <StyledInput value={editingItem.last_name || ''} onChange={e => setEditingItem({ ...editingItem, last_name: e.target.value })} />
                    </div>
                  </div>

                  <FormLabel>Role</FormLabel>
                  <StyledSelect value={editingItem.role || 'teacher'} onChange={e => setEditingItem({ ...editingItem, role: e.target.value })}>
                  ...
                  <StyledInput value={editingItem.email || ''} onChange={e => setEditingItem({ ...editingItem, email: e.target.value })} disabled={editingItem.id !== 'NEW'} />

                  {editingItem.role === 'teacher' && editingItem.id !== 'NEW' && (
                    <div style={{ marginTop: 16, padding: 18, backgroundColor: UI.soft, borderRadius: 14, border: `1px solid ${rgba(UI.accent, 0.45)}` }}>
              ...
              {activeTab === 'students' && (
                <>
                  ...
                  <StyledSelect value={editingItem.classroom_id ?? ''} onChange={e => setEditingItem({ ...editingItem, classroom_id: e.target.value })}>
              ...
              {activeTab === 'curriculum' && (
                <>
                  ...
                  <StyledSelect value={editingItem.category_id ?? ''} onChange={e => setEditingItem({ ...editingItem, category_id: e.target.value })}>
              ...
              {activeTab === 'calendar' && (
                <>
                  ...
                  <StyledInput value={editingItem.theme || ''} onChange={e => setEditingItem({ ...editingItem, theme: e.target.value })} />

                  <FormLabel>Term</FormLabel>
                  <StyledSelect value={editingItem.term_name || 'Term 1'} onChange={e => setEditingItem({ ...editingItem, term_name: e.target.value })}>
